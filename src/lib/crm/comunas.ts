// Listado de las 346 comunas de Chile agrupadas por región.
// Fuente: división político-administrativa vigente (16 regiones, 346 comunas).
// Fuente reutilizable para cualquier selector de comuna del sitio (no sólo el CRM).
...
export const REGIONES_COMUNAS: RegionComunas[] = [
  ...
  { region: "Libertador General Bernardo O'Higgins", comunas: ['Chépica', 'Chimbarongo', 'Codegua', 'Coínco', 'Coltauco', 'Doñihue', 'Graneros', 'La Estrella', 'Las Cabras', 'Litueche', 'Lolol', 'Machalí', 'Malloa', 'Marchihue', 'Mostazal', 'Nancagua', 'Navidad', 'Olivar', 'Palmilla', 'Paredones', 'Peralillo', 'Peumo', 'Pichidegua', 'Pichilemu', 'Placilla', 'Pumanque', 'Quinta de Tilcoco', 'Rancagua', 'Rengo', 'Requínoa', 'San Fernando', 'San Vicente', 'Santa Cruz'] },
  ...
  { region: 'Magallanes y de la Antártica Chilena', comunas: ['Antártica', 'Cabo de Hornos', 'Laguna Blanca', 'Natales', 'Porvenir', 'Primavera', 'Punta Arenas', 'Río Verde', 'San Gregorio', 'Timaukel', 'Torres del Paine'] },
];

/** Lista plana de las 346 comunas, ordenada alfabéticamente, para autocomplete simple. */
export const COMUNAS_CHILE: string[] = REGIONES_COMUNAS
  .flatMap((r) => r.comunas)
